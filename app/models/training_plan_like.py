...
class TrainingPlanLike(db.Model):
    __tablename__ = 'training_plan_like'
    ...
    user = db.relationship('User', back_populates='training_plan_like')
    training_plans = db.relationship('TrainingPlan', back_populates='training_plan_like')
